...
void
   ...
   /* ouputs */
   const char *fieldnames[] = {"F", "dFdsig2", "dFdB", "dFdl", "dFdh"};
   ...
   mxArray *mxF       = mxCreateDoubleMatrix(N, N, mxREAL); F = mxGetData(mxF);
   mxArray *mxdFds    = mxCreateDoubleMatrix(N, N, mxREAL); dFds = mxGetData(mxdFds);
   mxArray *mxdFdsig2 = mxCreateDoubleMatrix(N, N, mxREAL); dFdsig2 = mxGetData(mxdFdsig2);
   mxArray *mxdFdB    = mxCreateDoubleMatrix(N, N, mxREAL); dFdB = mxGetData(mxdFdB);
   mxArray *mxdFdl    = mxCreateDoubleMatrix(N, N, mxREAL); dFdl = mxGetData(mxdFdl);
   mxArray *mxdFdh    = mxCreateDoubleMatrix(N, N, mxREAL); dFdh = mxGetData(mxdFdh);
