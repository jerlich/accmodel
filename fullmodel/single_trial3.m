function [LL dLL likey output] = single_trial3(param, mydata, varargin)
...
if isempty(W0), %#ok<NODEF>
    W0 = make_each_F3(bo, sigma2_a, sigma2_s, lambda, dt, 'net_input', 0, 'nclicks', 0);
end;
W = make_each_F3(bo, sigma2_a, sigma2_s, lambda, dt, 'net_input', net_input, 'nclicks', nclicks, 'W0', W0);
...
% sigma2_s
    ...
    dLL(3) = sum(Deltak.sig2.*nclicks')/41;
