function [LL LL_grad likey param_full] = ll_model_wrapper35(param, ratdata, varargin)
% function [LL LL_grad likey param_full] = ll_model_wrapper35(param, ratdata, varargin)
...
if sum(do_param) ~= numel(param),
    fprintf(2, 'll_model_wrapper35: sum(do_param) does not match numel(param)!\n');
    display(do_param);
    display(param);
    return;
end;
...
if use_parallel,
    [LL LL_grad likey] = ll_all_trials35_parallel(param_full, ratdata, 'dx', dx, 'dt', dt, ...
    ...
    [LL LL_grad likey] = ll_all_trials35(param_full, ratdata, 'dx', dx, 'dt', dt, ...
                                       'total_rate', total_rate, ...
                                       'for_fmin', for_fmin, ...
                                       'var_mode', var_mode, ...
                                       'adapt_mode', adapt_mode, ...
...
if track_history,
    ...
    if isfield(history2, 'x'),
        ...
        fprintf(1, '\n\nll_model_wrapper35: unable to append current function call to history2\n\n');
    end
end;